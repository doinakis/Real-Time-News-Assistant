...
if __name__ == '__main__':
  ...
  parser.add_argument('--classifier', required=False, help='what type of query classification to use. (currently supporting tfidf and Bert')
  parser.add_argument('--reader_model', required=True, help='reader model to be used for the system evaluation')
  parser.add_argument('--retriever_model', required=True, help='retriever model to be used. (currently supporting bm25 and tfidf)')
